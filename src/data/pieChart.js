  ...
  legend: [
    {
      ...
      formatter: function(name) {
        ...
        return `{value|${legenddata[0].value}}{tag| |}{value|${parseInt(
          p
    ...
    },
    {
      ...
      formatter: function(name) {
        ...
        var p = (tarValue / total) * 100;
        return `{value|${legenddata[1].value}}{tag| |}{value|${parseInt(
          p
    ...
    },
    {
      ...
      formatter: function(name) {
        ...
        var p = (tarValue / total) * 100;
        return `{value|${legenddata[2].value}}{tag| |}{value|${parseInt(
          p
...
export { pieData, barOption2, barOption3, barOption4, barOption5 };
